...
module DataMemory(Address, WriteData, Clk, MemWrite, MemRead, ReadData, MemSize); 
    ...
    reg [31:0] memory[0:16383]; // 16K memory (16384 32-bit words)
                ...
                2: begin
                    ...
                    case (Address[1:0])
                        0: begin
                            ...
                            ReadData <= {{24{memory[Address[15:2]][7]}}, memory[Address[15:2]][7:0]};
                        end
                        1: begin
                            // Read second bottom most byte.
                            ReadData <= {{24{memory[Address[15:2]][15]}}, memory[Address[15:2]][15:8]};
                        end
                        2: begin
                            // Read second upper most byte.
                            ReadData <= {{24{memory[Address[15:2]][23]}}, memory[Address[15:2]][23:16]};
                        end
                        3: begin
                            // Read upper most byte.
                            ReadData <= {{24{memory[Address[15:2]][31]}}, memory[Address[15:2]][31:24]};
                        end
                    endcase
                end
                default: begin
        ...
        if (MemWrite) begin
            case (MemSize)
                ...
                1: begin
                    ...
                    if (Address[1] == 1'b1) begin
                        // Write upper half.
                        memory[Address[15:2]][31:16] <= WriteData[15:0];
                    end
                    else begin
                        // Write bottom half.
                        memory[Address[15:2]][15:0] <= WriteData[15:0];
                    end
                end
                2: begin
                    ...
                    case (Address[1:0])
                        0: begin
                            ...
                            memory[Address[15:2]][7:0] <= WriteData[7:0];
                        end
                        1: begin
                            // Write second bottom most byte.
                            memory[Address[15:2]][15:8] <= WriteData[7:0];
                        end
                        2: begin
                            // Write second upper most byte.
                            memory[Address[15:2]][23:16] <= WriteData[7:0];
                        end
                        3: begin
                            // Read upper most byte.
                            memory[Address[15:2]][31:24] <= WriteData[7:0];
                        end
                    endcase
                end
            endcase
