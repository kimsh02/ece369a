...
module DataMemory(Address, WriteData, Clk, MemWrite, MemRead, ReadData, MemSize); 
    ...
    reg [31:0] memory[0:1023]; // 1K memory (1024 32-bit words)
                ...
                2: begin
                    ...
                    case (Address[1:0])
                        ...
                        1: begin
                            ...
                            ReadData <= {{24{memory[Address[11:2]][15]}}, memory[Address[11:2]][15:8]};
                        end
                        2: begin
                            // Read second upper most byte.
                            ReadData <= {{24{memory[Address[11:2]][23]}}, memory[Address[11:2]][23:16]};
                        end
                        3: begin
                            // Read upper most byte.
                            ReadData <= {{24{memory[Address[11:2]][31]}}, memory[Address[11:2]][31:24]};
                        end
                    endcase
                end
                default: begin
